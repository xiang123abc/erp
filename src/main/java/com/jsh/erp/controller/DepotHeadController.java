...
public class DepotHeadController {
    ...
    public Object addDepotHeadAndDetail(@RequestParam("info") String beanJson,@RequestParam("inserted") String inserted,
        ...
        Long billsNumLimit = 1000L;
        if( request.getSession().getAttribute("billsNumLimit") != null){
            billsNumLimit = Long.parseLong(request.getSession().getAttribute("billsNumLimit").toString());
        }
        Long tenantId = 1000L;
